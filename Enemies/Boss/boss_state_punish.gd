class_name BossStatePunish
extends EnemyState

@onready var chase: EnemyState = $"../Chase"

@export var total_duration: float = 0.45
@export var hit_start_frame: int = 1
@export var hit_end_frame: int = 3
